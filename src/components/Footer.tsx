    ...
    <footer className="bg-muted/50 py-12">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-muted-foreground">
              Connecting mentors and learners for a smarter future
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <FooterLink href="/schedule" label="Schedule Mentorship" />
            </ul>
          </div>
          ...
          <div className="col-span-1">
            <h3 className="font-heading font-semibold text-lg mb-4">Subscribe</h3>
        ...
        <div className="border-t border-border mt-10 pt-6 text-center text-muted-foreground">
          <p>&copy; {currentYear} StepSmart. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
